...
class TestDefaultController(BaseTestCase):
    ...
    def test_base_de_datos_delete(self):
        ...
        response = self.client.open(
            '/matiaseiglesias/AppServer/1.0.0/base_de_datos',
            method='DELETE')
    ...
    def test_pin_get(self):
        ...
        """
        response = self.client.open(
            '/matiaseiglesias/AppServer/1.0.0/pin',
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_usuario_post(self):
        ...
        response = self.client.open(
            '/matiaseiglesias/AppServer/1.0.0/usuario',
            method='POST',
    ...
    def test_usuario_sesion_post(self):
        ...
        usuario = Usuario()
        response = self.client.open(
            '/matiaseiglesias/AppServer/1.0.0/usuario/sesion',
            method='POST',
